...
router.post('/logout', AuthMiddleware_1.authenticateJWT, HandleValidationErrors_1.handleValidationErrors, AuthController_1.AuthController.logout.bind(AuthController_1.AuthController));
